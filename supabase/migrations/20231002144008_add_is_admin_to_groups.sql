alter table "public"."layer_groups" add column "is_admin" boolean default false;

alter table "public"."organization_groups" add column "is_admin" boolean default false;

alter table "public"."project_groups" add column "is_admin" boolean default false;
