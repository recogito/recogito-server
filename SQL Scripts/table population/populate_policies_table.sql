...
VALUES ('6717fdc0-45df-46f3-b7d3-0d4c4569a33a','annotations','SELECT'),
       ...
       ('b4933e73-8a12-4827-a1aa-439a976693fc','groups','SELECT'),
       ('d51305e2-7ead-458b-bac5-ba430365fd04','groups','INSERT'),
       ('cc64ce27-d2f4-4338-bb9e-c9ff89126f79','groups','UPDATE'),
       ('4999ef7d-bef5-4c45-8b58-37af43b97e40','groups','DELETE'),
