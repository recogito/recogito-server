CREATE OR REPLACE FUNCTION check_action_policy_project_from_tag_definition(user_id uuid, table_name varchar, operation operation_types, tag_definition_id uuid) RETURNS bool AS $body$
DECLARE
    _scope      VARCHAR;
    _scope_id   UUID;
BEGIN
